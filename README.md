...
<head>
    ...
    <title>Em busca da cidade perdida - Paraná</title>
...
<body>
    <main>
        <div class="passo ativo" id="passo-0">
            ...
            <button class="btn-proximo" data-proximo="1">Paraná</button>
            <button class="btn-proximo" data-proximo="2">Pernambuco</button>
        </div>

        <div class="passo" id="passo-1">
            <p>Você começa sua jornada no Paraná, explorando as trilhas da Ilha do Mel, quando encontra uma construção antiga entre as pedras com uma inscrição misteriosa.</p>
            <button class="btn-proximo" data-proximo="3">Investigar a construção</button>
            <button class="btn-proximo" data-proximo="4">Ignorar e aproveitar a paisagem</button>
        </div>
        ...
        <div class="passo" id="passo-3">
            <p>Dentro da construção na Ilha do Mel, você encontra uma bússola antiga e um bilhete indicando que a próxima pista está escondida no coração da Amazônia.</p>
